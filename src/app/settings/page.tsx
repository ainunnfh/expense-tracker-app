    ...
    <div className="min-h-full flex-1 bg-zinc-50 dark:bg-black">
      <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
        ...
        <section className="mt-6 rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-950 sm:p-5">
          ...
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
            Tetapkan target pengeluaran per kategori untuk tiap periode.
          </p>
          <Link
            href="/settings/budget"
            className="mt-3 inline-block rounded-lg border border-zinc-200 bg-white px-3 py-2 text-xs font-medium text-zinc-900 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-50 dark:hover:bg-zinc-900"
          >
            Atur budget
          </Link>
        </section>
        ...
        <section className="mt-6 rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-950 sm:p-5">
          ...
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
            Tambah, ubah nama, atau hapus kategori pemasukan dan pengeluaran.
          </p>
          <Link
